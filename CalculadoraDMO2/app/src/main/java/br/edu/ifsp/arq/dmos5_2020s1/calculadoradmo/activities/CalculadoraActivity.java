...
public class CalculadoraActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoCE = findViewById(R.id.button_ce);
        ...
        botaoPotencia = findViewById(R.id.button_potencia);
        ...
        botaoCE.setOnClickListener(this);
        ...
        botaoPotencia.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if( v == botaoPotencia ){
            informaOperacao(constantes.POTENCIA);
        }
        if( v == botaoIgual ){
            calcular();
        }
